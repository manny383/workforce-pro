...
CREATE TABLE IF NOT EXISTS asistencias (
  ...
  biometria_verificada BOOLEAN NOT NULL DEFAULT FALSE,
  metodo_biometrico VARCHAR(50),
  biometria_credential_id VARCHAR(255),
  biometria_verificada_en DATETIME,
  latitud_entrada DECIMAL(10,8),
  longitud_entrada DECIMAL(11,8),
  precision_entrada DECIMAL(10,2),
